...
public class ClientMocksConfig {
    ...
    public static MockServerClient createExpectationAssertionFound() {
    ...
    public static MockServerClient createExpectationIdpTagsFound() {
    ...
    public static MockServerClient createExpectationIdpDataFound() {
        MockServerClient mockServerClient = new MockServerClient(LOCALHOST, 3001);
        mockServerClient
                .when(
                        request()
