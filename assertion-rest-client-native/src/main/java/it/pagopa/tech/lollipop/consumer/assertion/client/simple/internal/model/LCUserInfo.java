...
public class LCUserInfo extends AbstractOpenApiSchema {
    ...
    public static class LCUserInfoSerializer extends StdSerializer<LCUserInfo> {
        ...
        @Override
        public void serialize(LCUserInfo value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class LCUserInfoDeserializer extends StdDeserializer<LCUserInfo> {
        ...
        @Override
        public LCUserInfo deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for LCUserInfo: %d classes match result, expected 1", match));
        }
    ...
    /**
     * Get the actual instance of `OidcUserInfo`. If the actual instance is not `OidcUserInfo`,
    ...
    /**
     * Get the actual instance of `SamlUserInfo`. If the actual instance is not `SamlUserInfo`,
     * the ClassCastException will be thrown.
     *
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof SamlUserInfo) {
        if (getActualInstance() != null) {
          joiner.add(((SamlUserInfo)getActualInstance()).toUrlQueryString(prefix + "one_of_0" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof OidcUserInfo) {
        if (getActualInstance() != null) {
          joiner.add(((OidcUserInfo)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    return null;
