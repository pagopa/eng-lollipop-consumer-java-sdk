...
public class AssertionRef extends AbstractOpenApiSchema {
    ...
    public static class AssertionRefSerializer extends StdSerializer<AssertionRef> {
        ...
        @Override
        public void serialize(AssertionRef value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AssertionRefDeserializer extends StdDeserializer<AssertionRef> {
        ...
        @Override
        public AssertionRef deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for AssertionRef: %d classes match result, expected 1", match));
        }
