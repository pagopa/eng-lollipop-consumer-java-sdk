 ...
 */
@JsonPropertyOrder({
  OidcUserInfo.JSON_PROPERTY_ID_TOKEN,
  OidcUserInfo.JSON_PROPERTY_CLAIMS_TOKEN
})
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getClaimsToken() != null) {
      joiner.add(String.format("%sclaims_token%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getClaimsToken()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
