...
class AssertionSimpleClientTest {
    ...
    void assertionNotFound() {
        createExpectationAssertionNotFound();
        // setup
        Assertions.assertThrows(LollipopAssertionNotFoundException.class, () -> assertionSimpleClient.getAssertion(JWT, WRONG_ASSERTION_REF));
    }
    ...
    private void createExpectationAssertionNotFound() {
        new MockServerClient("localhost", 2000)
                .when(
                        request()
                                .withMethod("GET")
