...
class AssertionSimpleClientTest {
    ...
    AssertionSimpleClient assertionSimpleClient = new AssertionSimpleClient(new ApiClient());
    @Test
    ...
    void noJwt() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> assertionSimpleClient.getAssertion(jwt, assertionRef));
    }
    @Test
    void noAssertionRef() {
        // setup
