        ...
        public CertData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (((EntityDescriptor) deserialized).getEntityID() != null) {
                    ...
                    try{
                        deserialized = tree.traverse(jp.getCodec()).readValueAs(EntitiesDescriptor.class);

                        if (((EntitiesDescriptor) deserialized).getEntityList() != null) {
                            entitiesDescriptor.setEntityList(((EntitiesDescriptor) deserialized).getEntityList());
                        ...
                        log.log(Level.FINER, "Input data does not match schema 'Entities Descriptor'", e);
                    }
                }
            } catch (Exception e) {
                // deserialization failed, continue
