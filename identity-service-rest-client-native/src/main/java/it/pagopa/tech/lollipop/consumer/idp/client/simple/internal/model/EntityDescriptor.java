...
public class EntityDescriptor {
    ...
    /**
     * Methods that obtains the signature used for verify the user's assertion from a series
     * of nested objects contained in the idp certification xml
     *
    ...
    private void unpackNestedSignature(Map<String, Object> signature) {
        ...
        if (signature.get(KEY_DESCRIPTOR) instanceof List) {
            List<Map<String, Object>> listDescriptors = (List<Map<String, Object>>) signature.get(KEY_DESCRIPTOR);
            Optional<Map<String, Object>> optionalFirst = listDescriptors.stream().filter(el -> el.get("use").equals("signing")).findFirst();
