...
/**
 * Interface of the Http Verifier. This interface provides services through an implementation of the http-signature draft
 */
public interface HttpMessageVerifier {

    /**
     * Checks whether the calculated digest of the payload matches the content-digest of the http request
     * @param digest Content-Digest for the request payload
     * @param requestBody Request payload
     * @param encoding Encoding to be used for the payload. To be used if the underlying implementation checks uses the
     *                 content byte array
    ...
    /**
     * Checks whether the calculated signatures of the required parameter matches with those provided within
     * the Signature param
     * @param signature
