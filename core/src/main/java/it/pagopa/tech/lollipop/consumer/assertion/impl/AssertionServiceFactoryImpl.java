...
public class AssertionServiceFactoryImpl implements AssertionServiceFactory {
    ...
    @Inject
    public AssertionServiceFactoryImpl(AssertionStorageProvider assertionStorageProvider, AssertionClientProvider assertionClientProvider) {
    ...
    public AssertionService create() {
        return new AssertionServiceImpl(assertionStorageProvider.provideStorage(), assertionClientProvider.provideClient());
    }
}
